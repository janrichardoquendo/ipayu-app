 ...
 * <p>
 * @see POP3MessageInfo
 * @see DotTerminatedMessageReader
...
public class POP3Client extends POP3
{
     ...
     * {@link POP3#AUTHORIZATION_STATE AUTHORIZATION_STATE }
     * .  After logging in, the client enters the
     * {@link POP3#TRANSACTION_STATE TRANSACTION_STATE }
     * .
     * <p>
     ...
     * {@link POP3#getReplyString getReplyString }
     ...
     * you must call
     * {@link POP3#disconnect  disconnect }.
     * A logout attempt is valid in any state.  If
     * the client is in the
     * {@link POP3#TRANSACTION_STATE TRANSACTION_STATE }
     * , it enters the
     * {@link POP3#UPDATE_STATE UPDATE_STATE }
